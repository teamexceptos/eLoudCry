import 'package:eloudcry/screens/profile/create_profile_screen.dart';
                ...
                children: [
                  RichText(
                    ...
                    text: TextSpan(
                      ...
                      children: <TextSpan>[
                        ...
                        TextSpan(
                          text:
                              ' be your emergency by accepting needed permissions',
                          style: TextStyle(
                              color: XColors.white(),
                              fontSize: 26,
                              fontWeight: FontWeight.bold),
                  ...
                  Column(
                    children: [
                          ...
                          children: [
                            MkText(
                              ...
                              style: TextStyle(
                                ...
                                color: permissionsModel.setRecordings
                                    ? XColors.primaryColor()
                                    : XColors.white().withOpacity(0.4),
                              ),
                            ),
                            Icon(
                              Icons.mic,
                          ...
                          children: [
                            MkText(
                              ...
                              style: TextStyle(
                                fontSize: 21,
                                fontWeight: FontWeight.w800,
                                color: permissionsModel.setLocation
                                    ? XColors.primaryColor()
                                    : XColors.white().withOpacity(0.4),
                              ),
                            ),
                      ...
                      InkWell(
                        onTap: () async {
                          bool isSet = await PermissionService.requestPermission(
                              Permission.contacts);
                          ...
                          children: [
                            MkText(
                              ...
                              style: TextStyle(
                                fontSize: 21,
                                fontWeight: FontWeight.w800,
                                color: permissionsModel.setContacts
                                    ? XColors.primaryColor()
                                    : XColors.white().withOpacity(0.4),
                              ),
                            ),
                  ...
                  Column(
                    children: <Widget>[
                      Padding(
                        ...
                        child: MkButton(
                          onPressed: isAllSet ? () => navigateReplace(context, CreateProfileScreen()) : () {},
                          color: XColors.primaryColor(),
                          text: isAllSet ? "Create Profile" : "Set permissions",
